...
export default function BookingScreen() {
  ...
  const [users, setUsers] = useState([{ email: "", softs: 0, alcohols: 0 }]);
              ...
              >
                ...
                <View style={styles.drinkRow}>
                  ...
                  <View style={styles.counter}>
                    ...
                    <TouchableOpacity
                      onPress={() =>
                        updateUser(idx, "alcohols", user.alcohols + 1)
                      }
                      style={styles.counterBtn}
                    >
                      <Text style={styles.counterBtnText}>+</Text>
                ...
                <View style={styles.drinkRow}>
                  ...
                  <View style={styles.counter}>
                    <TouchableOpacity
                      onPress={() =>
                        updateUser(idx, "softs", Math.max(0, user.softs - 1))
                      }
                      style={styles.counterBtn}
                    >
                      <Text style={styles.counterBtnText}>-</Text>
                    ...
                    <TouchableOpacity
                      onPress={() => updateUser(idx, "softs", user.softs + 1)}
                      style={styles.counterBtn}
                    >
                      <Text style={styles.counterBtnText}>+</Text>
                    </TouchableOpacity>
